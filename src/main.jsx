        ...
        <aside className="controls-card">
          ...
          <section>
            ...
            <div className="line-mode-picker" role="group" aria-label="Line type">
              <button className={`line-mode start-mode ${lineMode === START ? 'active' : ''}`} onClick={() => setLineMode(START)}><span className="mode-swatch start-swatch" />Question start</button>
              <button className={`line-mode end-mode ${lineMode === END ? 'active' : ''}`} onClick={() => setLineMode(END)}><span className="mode-swatch end-swatch" />Question end</button>
              <button className={`line-mode part-mode ${lineMode === PART ? 'active' : ''}`} onClick={() => setLineMode(PART)}><span className="mode-swatch part-swatch" />Part</button>
            </div>
            <p className="small">Click the rolling paper to add the selected line. Drag to move; double-click to remove. Blue lines mark useful internal parts.</p>
